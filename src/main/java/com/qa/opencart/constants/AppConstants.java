...
public class AppConstants {
	...
	public static final List<String> EXPECTED_LOGIN_PAGE_HEADERS_LIST = List.of("Desktops", "Laptops & Notebooks", "Components", "Tablets","Software","Phones & PDAs","Cameras","MP3 Players");
