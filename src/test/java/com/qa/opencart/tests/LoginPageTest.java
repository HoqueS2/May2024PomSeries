...
public class LoginPageTest extends BaseTest {
	...
	@Test
	public void getLoginPageHeaderManuTest() {
		//loginPage.getLoginPageHeaderManu();
		List<String> actualHeadersList=loginPage.getLoginPageHeaderManu();
		Assert.assertEquals(actualHeadersList, AppConstants.EXPECTED_LOGIN_PAGE_HEADERS_LIST);
	}
